 ...
 // Check setLocation is add product to cart
	...
	var ajaxtoolbar	=	function(){
		function lockshowloading(){
			...
			img	=	"<div style='position:absolute;top:200px;left:50%;margin-left:-33px;z-index:889'><img src='"+toolbarBaseurl+"frontend/default/default/VS/images/ajaxloading.gif'/></div>";
